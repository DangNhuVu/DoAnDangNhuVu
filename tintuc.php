<div id="tintuc">
	...
	$stm = $o->query("SELECT * FROM tintuc ORDER by matt DESC  LIMIT $from, $max_results");
	$tintuc = $stm->fetchAll();
    ...
    <div class="tintuccon">
        <div class="tintuccon-in">
            <div class="tieudetintuc">
                <p><a
                        href="index.php?content=chitiettintuc&matt=<?php echo $row['matt'] ?>"><?php echo $row['tieude'] ?></a>
                </p>
...
<div id="phantrang_sp">
	...
	$total_results = $o->query($o->query("SELECT COUNT(*) as Num FROM tintuc"), 0);
