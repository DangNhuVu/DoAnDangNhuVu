...
<table>
	...
	$sql = $o->query("SELECT * FROM tintuc order by matt DESC LIMIT $from, $max_results")->fetchAll();
...
<div id="phantrang_sp">
	...
	$total_results = $o->query("SELECT COUNT(*) as Num FROM tintuc")->fetchAll();
	$total_results = $total_results[0][0];
