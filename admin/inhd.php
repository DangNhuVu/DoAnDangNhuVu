    ...
    <div id="wrapper" style="margin:0 auto; width:500px;">
        <table width="100%">
                                                ...
                                                <tr>
                                                    <td>
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td colspan="2"><strong>CỬA HÀNG ĐIỆN THOẠI ĐẶNG NHƯ
                                                                            VŨ</strong></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Địa chỉ</td>
                                                                    <td>: 180 Cao Lỗ Phường 4 Quận 8 TPHCM</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="65">Tel:</td>
                                                                    <td>: 0424 4242442</td>
            ...
            ?>
              ...
              $rows2 = $o->query($sql2)->fetchAll();
              $row2 = $rows2[0];

              ?>
                            <td><?php if ($row2['phuongthucthanhtoan'] == 1) echo "Qua bưu điện";
                  else if ($row2['phuongthucthanhtoan'] == 2) echo "Qua thẻ ATM";
                  else echo "Thanh toán trực tiếp"; ?></td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <table width="100%" style="border-collapse:collapse;">
                        <tr>
                            ...
                            <td width="25%" align="right" bgcolor="#CCCCCC" align="left"
            ...
            ?>
                        <tr>
                            ...
                            <td align="center" align="left" style="border:1px solid green;">
                                <?php echo number_format($row['gia'], "0", ",", ".") ?> VNĐ</td>
                            <td align="center" align="left" style="border:1px solid green;">
                                <?php echo $row['soluong'] ?></td>
                            <td align="center" align="left" style="border:1px solid green;">
                                <?php echo number_format($thanhtien, "0", ",", ".") ?> VNĐ</td>
                        </tr>
                        <?php } ?>
                    ...
                    <table width="452" border="0" align="right">
                        <tr>
                            <td colspan="3">
                                <div align="right"> Ngày <?php echo date("d/m/Y"); ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
