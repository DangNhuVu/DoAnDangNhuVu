...
<body>
    <div id="wapper">
        <div id="header">
            <!-- <div id="lg-header"> -->
            <h1 style="float: left; padding-top: 50px; padding-left: 50px;"><a href="../index.php">LOGO</a></h1>
            <!-- </div> -->
            <div id="bg-header">
            </div><!-- End .bg-header -->
        </div><!-- End .header -->
        <div id="content">
            <div id="top-content">
                <p>Chào bạn <font color="green"><b><u><?= $_SESSION['username'] ?></u></b></font><a href="logout.php"> |
                        Thoát</a></p>
            </div>
            <div id="main-content">
                <div id="left-content">
