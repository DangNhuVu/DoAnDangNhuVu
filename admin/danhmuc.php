...
$hienthi = $o->query("SELECT * FROM danhmuc")->fetchAll();
$dem = count($hienthi);
?>
<div class="quanlysp">
...
<form action="" method="post" name="frmTest" onsubmit="if(CheckForm() == false) return false">
    <table align="center" border="0">
        ...
        <tr>
            ...
            <td class="active_hienthi_sp"><a href="?admin=suadm&madm=<?php echo $bien['madm'] ?>"> <img
                        src="img/sua.png" title="Sửa" /></a>
