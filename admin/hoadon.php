...
<table>
	...
	$sql = $o->query("SELECT * FROM hoadon ORDER by mahd DESC  LIMIT $from, $max_results")->fetchAll();
    ...
    <tr class='noidung_hienthi_sp'>
        ...
        <td class="active_hienthi_sp" style="width:70px;"><a
                href="admin.php?admin=chitiethoadon&mahd=<?php echo $bien['mahd']; ?> " style="float:left;">Chi tiết</a>
...
<div id="phantrang_sp">
	...
	$subquery = $o->query("SELECT COUNT(*) as Num FROM sanpham")->fetchAll();
	$total_results = $subquery[0][0];
