...
<body>
	...
	if (isset($_POST['btnthem'])) {
		$tendm = $_POST['tendm'];
		$dequi = $_POST['dequi'];
		$insertdm = $o->query("INSERT INTO danhmuc VALUES('', '$tendm', '$dequi') ");
		if ($insertdm) {
            ...
            <tr>
                ...
                <td>
                    <select name="dequi">
                        ...
                        <?php
						$show = $o->query("SELECT * FROM danhmuc WHERE dequi=0")->fetchAll();
						foreach ($show as $show1) {
							$madm = $show1['madm'];
							$tendm = $show1['tendm'];
							echo "<option value='" . $madm . "'>" . $tendm . "</option>";
							$show2 = $o->query("SELECT * FROM danhmuc WHERE dequi='" . $madm . "'")->fetchAll();
