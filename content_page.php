	...
	<div class="sanpham">
	    <?php
				...
				$result1 = $o->query($sql1);
				$row = $result1->fetchAll();
				?>
	    <h2><?php echo $row[0]['tendm'] ?></h2>
	    <div class="sanphamcon">
	        ...
	        <div class="dienthoai">
	            ...
	            <h4><?php echo number_format(($result['gia'] * ((100 - $result['khuyenmai1']) / 100)), 0, ",", "."); ?>
	            </h4>
	            <div class="button">
	                <ul>
	                    <li>
	...
	<div class="phantrang">
	    <?php
				...
				$subquery = $o->query("SELECT COUNT(*) as Num FROM sanpham where madm='{$_GET['madm']}'");
				$total_results = $subquery[0]['Num'];
