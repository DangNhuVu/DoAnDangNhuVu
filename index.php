<!-- <base href="http://localhost/DangNhuVu/" /> -->
<?php
session_start();
        ...
        <div id="footer">
            ...
            <div id="bg-footer">
                <div id="noidungfooter">
                    ...
                    <div id="noidung">
                        <ul>
                            <li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI DANGNHUVU</span></li> <br>

                            <li>Địa chỉ: 180 Cao Lỗ Phường 4 Quận 8 TPHCM </li>
                            <li>Điện thoại: 090000000 - Hotline: 0123456789</li>
                            <li>Email: support@dangnhuvu.info</li>
                        </ul>
                    </div><!-- End .noidung -->
                    <div id="thanhngang">
