					...
					$sql_Dem = "SELECT count(*) as dem from sanpham";
					$tongsoluong = $o->query($sql_Dem)->fetchAll();
					$tongsoluong = $tongsoluong[0]['dem'];

					//echo "<h3>Tong so luong la: $tongsoluong</h3><br><br>";
					echo "<h3>Tong so luong la: </h3><br><br>";
					...
					?> <div class="sanpham"> <?php
					    ...
					    <div class="sanphamcon">
					        ...
					        <div class="dienthoai">
					            ...
					            <h4><?php echo number_format(($rows['gia'] * ((100 - $rows['khuyenmai1']) / 100)), 0, ",", "."); ?>
					            </h4>
					            <div class="button">
					                <ul>
					                    <li>
					                    ...
					                    <li>
					                        <h5><a href="index.php?content=cart&action=add&idsp=<?php echo $rows['idsp'] ?>"><button>Cho
					                                    vào giỏ</button></a></h5>
					                    </li>
					                </ul>
					            </div><!-- End .button-->
